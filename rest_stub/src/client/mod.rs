    ...
    C: Has<XSpanIdString>  + Clone + Send + Sync + 'static,
{
        ...
        context: &C) -> Result<AdminUsersGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    AdminUsersGetResponse::ListOfUsersRetrievedSuccessfully
                )
            }
            code => {
        ...
        context: &C) -> Result<AdminUsersIdDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    AdminUsersIdDeleteResponse::UserDeletedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<AdminUsersIdPutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    AdminUsersIdPutResponse::UserUpdatedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<DiagramsIdExportPostResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    DiagramsIdExportPostResponse::DiagramExportedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<DiagramsImportPostResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    DiagramsImportPostResponse::DiagramImportedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<EntitiesGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    EntitiesGetResponse::AListOfEntities
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<EntitiesIdDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    EntitiesIdDeleteResponse::EntityRemovedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<EntitiesIdGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    EntitiesIdGetResponse::EntityDetails
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<EntitiesIdPutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    EntitiesIdPutResponse::EntityUpdatedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<EntitiesPostResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    EntitiesPostResponse::EntityAddedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<GraphsGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    GraphsGetResponse::AListOfGraphs
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<GraphsIdDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    GraphsIdDeleteResponse::GraphDeletedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<GraphsIdGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    GraphsIdGetResponse::GraphDetails
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<GraphsIdPutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    GraphsIdPutResponse::GraphUpdatedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<GraphsPostResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    GraphsPostResponse::GraphCreatedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<RelationshipsGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    RelationshipsGetResponse::AListOfRelationships
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<RelationshipsIdDeleteResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    RelationshipsIdDeleteResponse::RelationshipDeletedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<RelationshipsIdGetResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    RelationshipsIdGetResponse::RelationshipDetails
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<RelationshipsIdPutResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    RelationshipsIdPutResponse::RelationshipUpdatedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<RelationshipsPostResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    RelationshipsPostResponse::RelationshipCreatedSuccessfully
                )
            }
            code => {
                let headers = response.headers().clone();
        ...
        context: &C) -> Result<SparqlQueryPostResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                Ok(
                    SparqlQueryPostResponse::QueryExecutedSuccessfullyAndResultsReturned
                )
            }
            code => {
                let headers = response.headers().clone();
